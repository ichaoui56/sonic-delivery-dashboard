  ...
  return (
    <DashboardLayout userRole={userRole}>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-3">
              ...
              <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-[#048dba] text-white">
                {userRole}
              </span>
            </div>
        ...
        {isAdmin ? (
          <>
            <Card className="bg-gradient-to-br from-[#048dba] to-[#8BC34A]">
              <CardHeader>
                <div className="flex items-center gap-3">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-full bg-[#048dba]"></div>
                  ...
                  <div className="mt-6 text-center">
                    <div className="text-5xl font-bold text-[#048dba] mb-2">0%</div>
          ...
          <Card>
            <CardContent className="py-12">
              <div className="text-center text-gray-500">
                ...
                <p className="text-lg font-medium mb-2">الوصول محدود</p>
                <p className="text-sm">هذه اللوحة متاحة للمديرين فقط</p>
              </div>
            </CardContent>
          </Card>
        )}
